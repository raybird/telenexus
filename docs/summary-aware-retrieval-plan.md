...
- 想知道 TeleNexus 是什麼、怎麼上手：看 `README.md`
- 想先找到正確的文件入口：看 `docs/README.md`
- 想知道目前固定保留哪些高價值規則：看 `docs/canonical-sar-anchors.md`
- 只有在要調整記憶檢索行為時，才需要深入這份文件
...
這一節是本文最重要的現況入口；後面多數章節保留了原始規劃脈絡，閱讀時請優先以這裡的校準內容為準。
